...
Taken from \cite{MT2_2019}.}
  ...
  \begin{table}[htbp]
    ...
    \end{tabular}
    \topcaption[Summary table of baseline event selection.]{A summary of the baseline event selection for the classic \mttwo search.
...
\section{Disappearing Tracks Search} \label{sec:distracks}
  ...
  \begin{table}[htbp]
    \topcaption[Table of ST and STC selections.]
    ...
    \begin{tabular}{l | l | c | c}
      ...
      \hline
      \pt [GeV]                                            & $> 15$         & All                     & \\
      $\left|\eta\right|$                                 & $< 2.4$ \& not $1.38 < \left|\eta\right| < 1.6$ & All & \\
